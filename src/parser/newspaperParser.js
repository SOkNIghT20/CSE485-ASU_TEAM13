...
const Insert = require('./../../server/routes/newspaperResultHandler');
const Feeds = require('./../../server/routes/getNewspaperFeedsHandler');
const Cleanup = require('./../../server/routes/newspaperCleanupHandler');
...
module.exports = {
  runParser: function(DAYS_FOR_CLEANUP){
    ...
    Feeds.getFeeds().then(rows =>{
      ...
      console.log("Couldn't start newspaper parser")
      console.error(err);
    });
  }
};
