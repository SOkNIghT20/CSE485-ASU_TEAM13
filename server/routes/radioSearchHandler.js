...
exports.getSearchResults = async function (searchQuery, selectedRadio, allPapers, country,
					allCountries, stateProvince, allStates, city, allCities,
					startDateTime, endDateTime, numOfRecords) {
    const query = 'CALL dc.Radio_Search(?,?,?,?,?,?,?,?,?,?,?,?)';
